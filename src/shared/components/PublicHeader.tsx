    ...
    <header className="border-b border-cyan-200 shadow-sm">
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <ul className="flex space-x-6 items-center">
          <li><Link to="/" className="text-gray-300 hover:text-cyan-500 font-medium">Home</Link></li>
          ...
          {user && (
            <>
            <li>
              <Link to="/profile" className="flex items-center gap-2 text-gray-300 hover:text-cyan-500">
            ...
            <li><Link to="/createcuriosity" className="text-gray-300 hover:text-cyan-500 font-medium">Create Curiosity</Link></li>
